"""
OVO JE FINALAN KOD, POSTO SE KORISTI SAMO JEDANPUT ZA UNOS PODATAKA U BAZU, NISAM RADIO ZASEBNO POVLACENJE ZANROVA,
VEC SE U KODU IZMJENI PAR LINIJA U CILJU PROMJENE ZANRA PJESAMA.
"""
...
def get_site(year):
	response = get_website(f'https://playback.fm/charts/rnb/{year}')
...
def format_link(year, artist, song):
	url = f'https://playback.fm/charts/rnb/video/{year}/'
...
insert_into_database(master_list)
